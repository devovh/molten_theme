{$head}
		...
		<div class="social_holder vertical_center">
			...
			<a href="http://molten.online/forum/misc/contact" target="_blank" class="social_support" title="{sprintf(lang('molten_social_support', 'theme_molten'), $serverName)}"></a>
		</div>
		<!-- Social.End -->
		...
		<div class="main_container">
										...
										<li class="dropdown">
											...
											<div class="dropdown-holder">
												<ul class="navi-dropdown border_box">							
													<li><a href="{$url}page/connect">How to Connect</a></li>
													<li><a href="{$url}bugtracker">Bugtracker</a></li>
													<li><a href="{$url}changelog">Changelog</a></li>
													<li><a href="{$url}armory">Armory</a></li>
													<li><a href="{$url}character_tools">Character Tools</a></li>
													<li><a href="{$url}character_transfer">Character Transfer</a></li>
													<li><a href="{$url}gm_apply">GM Application</a></li>
												</ul>
											</div>
										</li>
										<!-- Dropdown.End -->
			...
			<div class="row row-2 self_clear">
				...
				<div class="col col-mid">
					<!-- Slider -->
					<div id="slider_container" class="slider_container border_box" {if !$show_slider}{/if}>
						<div id="slider">
					...
					<aside id="left" class="sidebar">
						{foreach from=$sideboxes key=key item=sidebox}
							...
							{if sizeof($sidebox_name) == 2}
								<section id="sidebox-{$key}" class="sidebox sidebox-{reset($sidebox_name)} special border_box {if $key == end($sideboxes)}last-row{/if}">
									<h4 class="sidebox_title border_box">{next($sidebox_name)}</h4>
									<div class="sidebox_body">{$sidebox.data}</div>
								</section>
							{else}
								<section id="sidebox-{$key}" class="sidebox border_box {if $key == end($sideboxes)}last-row{/if}">
					...
					<footer id="footer">
						<div class="holder">
							<div class="useful-links">
								<a href="http://molten.online/page/tos">Terms of Service</a>
								<a href="http://molten.online/page/privacy">Privacy Policy</a>
								<a href="http://molten.online/page/refund">Refund Policy</a>
								<a href="http://molten.online/forum/misc/contact">Contact Us</a>
							</div>
